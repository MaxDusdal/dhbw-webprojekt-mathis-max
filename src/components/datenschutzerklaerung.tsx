  ...
  return (
    <>
      <div className="text-sm text-gray-700 font-light">
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m716">
          Präambel
        </h2>
        <p>
        ...
        <p>Stand: 1. Oktober 2024</p>
       <h2 className="text-xl mt-4 font-bold text-gray-900">Inhaltsübersicht</h2>{" "}
        <ul className="index list-disc text-blue-600 space-y-1 underline underline-offset-4">
          <li>
            <a className="index-link hover:bg-blue-100 transition-all duration-300 p-1 rounded-md" href="#m716">
              Präambel
            </a>
          </li>
          <li>
            <a className="index-link hover:bg-blue-100 transition-all duration-300 p-1 rounded-md" href="#m3">
              Verantwortlicher
            </a>
          </li>
          <li>
            <a className="index-link hover:bg-blue-100 transition-all duration-300 p-1 rounded-md" href="#mOverview">
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m3">
          Verantwortlicher
        </h2>
        <p>
          LuftBNB GmbH
        ...
        <p>Vertretungsberechtigte Personen: Mathis Dusdal</p>
        <p>
          E-Mail-Adresse:{" "}
          <a href="mailto:luftbnb@dusdal.dev">luftbnb@dusdal.dev</a>
        </p>
        <p>Telefon: 012345678910</p>
        <p>Impressum: luftbnb.vercel.app/impressum</p>
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="mOverview">
          Übersicht der Verarbeitungen
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m2427">
          Maßgebliche Rechtsgrundlagen
        </h2>
        <p>
        ...
        <p>
          ...
          Daten" verwendet. Die gesetzliche Bedeutung der Begriffe wird jedoch
          im Rahmen der Geltung des Schweizer DSG weiterhin nach dem Schweizer
          DSG bestimmt.
        </p>
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m27">
          Sicherheitsmaßnahmen
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m25">
          Übermittlung von personenbezogenen Daten
        </h2>
        <p>
        ...
        <p>
          ...
          unserer Organisation übermitteln oder ihnen den Zugriff darauf
          gewähren. Sofern die Datenweitergabe zu administrativen Zwecken
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m24">
          Internationale Datentransfers
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m12">
          Allgemeine Informationen zur Datenspeicherung und Löschung
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            ...
            allgemeinen Fristen gelten für die Aufbewahrung und Archivierung
            ...
            <ul>
              <li>
                ...
                und sonstigen Organisationsunterlagen, Buchungsbelege und
                Rechnungen (§ 147 Abs. 3 i. V. m. Abs. 1 Nr. 1, 4 und 4a AO, §
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m10">
          Rechte der betroffenen Personen
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m317">
          Geschäftliche Leistungen
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m13">
          Geschäftsprozesse und -verfahren
        </h2>
        <p>
        ...
        <ul className="m-elements">
          ...
          <li>
            ...
            betriebswirtschaftliche Verfahren; Sicherheitsmaßnahmen.
            Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.
          </li>
          <li>
            <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend
        ...
        <ul className="m-elements">
          <li>
            ...
            Onlineangebotes ein Konto anlegen (z.&nbsp;B. Kunden- bzw.
            Nutzerkonto, kurz "Kundenkonto"). Falls die Registrierung eines
            Kundenkontos erforderlich ist, werden Kunden hierauf ebenso
            ...
            Missbrauch des Kundenkontos vorbeugen zu können. Wurde das
          ...
          <li>
            <strong>Wirtschaftliche Analysen und Marktforschung: </strong>Zur
            ...
            analysiert. In die Gruppe der betroffenen Personen können
            Vertragspartner, Interessenten, Kunden, Besucher und Nutzer des
            Onlineangebotes des Verantwortlichen fallen. Die Durchführung der
            Analysen dient den Zwecken der betriebswirtschaftlichen
            ...
            Dabei werden, sofern vorhanden, Profile von registrierten Nutzern
            samt ihrer Angaben zu in Anspruch genommenen Leistungen
            berücksichtigt. Die Analysen dienen ausschließlich dem
            Verantwortlichen und werden nicht extern offenbart, außer es handelt
            sich um anonyme Analysen mit zusammengefassten, also anonymisierten
            Werten. Zudem wird auf die Privatsphäre der Nutzer Rücksicht
            genommen; die Daten werden für Analysezwecke möglichst
            pseudonymisiert und, sofern machbar, anonymisiert verarbeitet
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m326">
          Zahlungsverfahren
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            ...
            mit Inhalten und Funktionen); Meta-, Kommunikations- und
            Verfahrensdaten (z. B. IP-Adressen, Zeitangaben,
            Identifikationsnummern, beteiligte Personen). Kontaktdaten
        ...
        <ul className="m-elements">
          <li>
            ...
            <strong>Dienstanbieter:</strong> Amazon Payments Europe S.C.A. 38
            ...
            <a href="https://pay.amazon.de/" target="_blank">
              https://pay.amazon.de/
            </a>
          ...
          <li>
            ...
            <strong>Dienstanbieter:</strong> Apple Inc., Infinite Loop,
          ...
          <li>
            ...
            Anbindung von Online-Bezahlmethoden);{" "}
            <strong>Dienstanbieter:</strong> giropay GmbH, An der Welle 4, 60322
          ...
          <li>
            ...
            Anbindung von Online-Bezahlmethoden);{" "}
            <strong>Dienstanbieter:</strong> Klarna Bank AB (publ), Sveavägen
          ...
          <li>
            ...
            Anbindung von Online-Bezahlmethoden);{" "}
            <strong>Dienstanbieter:</strong> Mastercard Europe SA, Chaussée de
            Tervuren 198A, B-1410 Waterloo, Belgien;{" "}
            <span className="">
              <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und
              vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO);{" "}
            </span>
          ...
          <li>
            ...
            Anbindung von Online-Bezahlmethoden) (z.&nbsp;B. PayPal, PayPal
            Plus, Braintree); <strong>Dienstanbieter:</strong> PayPal (Europe)
          ...
          <li>
            <strong>Visa: </strong>Zahlungsdienstleistungen (technische
            Anbindung von Online-Bezahlmethoden);{" "}
            <strong>Dienstanbieter:</strong> Visa Europe Services Inc.,
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m225">
          Bereitstellung des Onlineangebots und Webhosting
        </h2>
        <p>
        ...
        <ul className="m-elements">
          ...
          <li>
            ...
            Rechenkapazitäten); <strong>Dienstanbieter:</strong> 1&amp;1 IONOS
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m367">
          Registrierung, Anmeldung und Nutzerkonto
        </h2>
        <p>
        ...
        <p>
          ...
          sind, wie z.&nbsp;B. technische Änderungen, per E-Mail informiert
          werden.
        </p>
        <ul className="m-elements">
          <li>
            ...
            Inhalten und Funktionen). Protokolldaten (z.&nbsp;B. Logfiles
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m182">
          Kontakt- und Anfrageverwaltung
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m136">
          Präsenzen in sozialen Netzwerken (Social Media)
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            ...
            von Fotos und Videos, das Kommentieren und Favorisieren von
          ...
          <li>
            ...
            betrifft; <strong>Dienstanbieter:</strong> Meta Platforms Ireland
          ...
          <li>
            <strong>Pinterest: </strong>Soziales Netzwerk, ermöglicht das Teilen
            von Fotos, Kommentieren, Favorisieren und Kuratieren von Beiträgen,
            Nachrichtenversand, Abonnieren von Profilen;{" "}
            <strong>Dienstanbieter:</strong> Pinterest Europe Limited, 2nd
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m328">
          Plug-ins und eingebettete Funktionen sowie Inhalte
        </h2>
        <p>
        ...
        <ul className="m-elements">
          <li>
            ...
            mit Inhalten und Funktionen); Meta-, Kommunikations- und
            Verfahrensdaten (z. B. IP-Adressen, Zeitangaben,
            Identifikationsnummern, beteiligte Personen); Bestandsdaten
            (z.&nbsp;B. der vollständige Name, Wohnadresse,
            Kontaktinformationen, Kundennummer, etc.); Kontaktdaten (z.&nbsp;B.
            Post- und E-Mail-Adressen oder Telefonnummern); Inhaltsdaten (z. B.
            textliche oder bildliche Nachrichten und Beiträge sowie die sie
            betreffenden Informationen, wie z. B. Angaben zur Autorenschaft oder
            Zeitpunkt der Erstellung). Standortdaten (Angaben zur geografischen
        ...
        <ul className="m-elements">
          ...
          <li>
            ...
            gehören; <strong>Dienstanbieter:</strong> Google Cloud EMEA Limited,
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m15">
          Änderung und Aktualisierung
        </h2>
        <p>
       ...
       <h2 className="text-xl mt-4 font-bold text-gray-900" id="m42">
          Begriffsdefinitionen
        </h2>
        <p>
