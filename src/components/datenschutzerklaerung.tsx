export default function DatenschutzErklaerung() {
  return (
    <>
      ...
      <p>
        Vertretungsberechtigte Personen: Mathis Challand &amp; Maximilian Tim
        Dusdal
      </p>
      <p>
        E-Mail-Adresse: <a href="mailto:luftnbn@dusdal.de">luftnbn@dusdal.de</a>
      </p>
      <p>Telefon: 01745259553</p>
      <p>Impressum: luftnbn.server.dusdal.dev/impressum</p>
      ...
      <ul className="m-elements">
        <li>
          ...
          des Kundenkontos nach dem Kündigungszeitpunkt gelöscht, sofern sie
